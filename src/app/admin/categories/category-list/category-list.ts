...
export class CategoryListComponent implements OnInit {
  ...
  loadCategories() {
    ...
    console.log('CategoryListComponent: Checking slug', slug);

    if (slug) {
      this.categoryService.getCategories().subscribe({
        next: (data) => {
          console.log('CategoryListComponent: Received categories', data);
          this.categories = data;
          this.cdr.detectChanges();
        },
        error: (err) => console.error('CategoryListComponent: Error', err)
      });
    }
  }
